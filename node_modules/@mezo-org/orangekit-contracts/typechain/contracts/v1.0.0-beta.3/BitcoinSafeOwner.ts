...
export interface BitcoinSafeOwnerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
...
export interface BitcoinSafeOwner extends BaseContract {
  connect(runner?: ContractRunner | null): BitcoinSafeOwner;
  waitForDeployment(): Promise<this>;

  interface: BitcoinSafeOwnerInterface;
