...
export interface OrangeKitSafeFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface OrangeKitSafeFactory extends BaseContract {
  connect(runner?: ContractRunner | null): OrangeKitSafeFactory;
  waitForDeployment(): Promise<this>;

  interface: OrangeKitSafeFactoryInterface;
  ...
  initialize: TypedContractMethod<
    [
      _safeSingleton: AddressLike,
      _safeOwnerSingleton: AddressLike,
      _emergencyGovernance: AddressLike
    ],
    [void],
    "nonpayable"
  >;
