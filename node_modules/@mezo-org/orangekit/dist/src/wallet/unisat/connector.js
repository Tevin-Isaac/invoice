...
export function getOrangeKitUnisatConnector({ rpcUrl, chainId, relayApiKey, }) {
    ...
    return () => createOrangeKitConnector(OrangeKitWalletId.UNISAT, "Unisat", icon, rpcUrl, chainId, bitcoinWalletProvider, relayApiKey);
}
