...
export default function getOrangeKitXverseConnector({ rpcUrl, chainId, relayApiKey, }) {
    ...
    return () => createOrangeKitConnector(OrangeKitWalletId.XVERSE, "Xverse", icon, rpcUrl, chainId, bitcoinWalletProvider, relayApiKey);
}
