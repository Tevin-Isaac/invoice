import { ContractTransaction, Provider, TransactionResponse } from "ethers";
...
export declare class OrangeKitSmartAccount {
    ...
    constructor(provider: Provider, _chainId: number, contracts: OrangeKitContracts, transactionSender: TransactionSender);
    get chainId(): number;
     ...
     */
    predictAddress(bitcoinAddress: string, publicKey?: string): Promise<Hex>;
     ...
     */
    populateSafeDeploymentTransaction(bitcoinAddress: string, publicKey?: string): Promise<ContractTransaction>;
    deploySafe(bitcoinAddress: string, relayerPrivateKey: string, rpcUrl: string): Promise<TransactionResponse>;
     ...
     */
    sendTransaction(to: string, value: string, data: string, bitcoinAddress: string, publicKey: string, bitcoinSignMessageFn: BitcoinSignSafeTransactionMessageFn): Promise<string>;
}
