...
describe("OrangeKitSmartAccount", () => {
    beforeEach(() => {
        ...
        orangekitSmartAccount = new OrangeKitSmartAccount(client, 1, contracts, transactionSender);
    });
    ...
    describe("predictAddress", () => {
        describe("with Bitcoin address input", () => {
            it.each(predictAddressTestData.passTestDataWithBitcoinAddressInput)("should predict address for input of $description", async ({ input, output }) => {
                const result = await orangekitSmartAccount.predictAddress(...input);
                expect(result).toBe(output);
            });
            it.each(predictAddressTestData.failTestDataWithBitcoinAddressInput)("should throw error for input of $description", ({ input, output }) => {
