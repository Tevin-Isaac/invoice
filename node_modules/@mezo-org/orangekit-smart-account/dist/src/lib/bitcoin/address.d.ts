...
declare function toNestedSegwitAddress(compressedPublicKey: BytesLike, isTestnet?: boolean): string;
/**
...
declare function recoverTruncatedBitcoinAddress(bitcoinAddress: string, publicKey?: string): string;
