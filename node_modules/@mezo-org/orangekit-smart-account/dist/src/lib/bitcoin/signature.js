 ...
 */
function normalizeV(v, rangeMin, setHighBit = false) {
 ...
 */
function normalizeSignature(signature, bitcoinAddress, publicKey) {
    ...
    else if (BitcoinAddressHelper.isNestedSegwitAddress(bitcoinAddress, publicKey)) {
    ...
    return hexlify(normalizedSignature);
}
export default {
    normalizeV,
    normalizeSignature,
